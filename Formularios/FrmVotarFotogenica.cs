...
namespace SIEleccionReina.Formularios
{
    public partial class FrmVotarFotogenica : Form
    {
        ...
        {   // TODO: Establecer apropiadamente el idCandidata cuando este lista la coleccion de candidatas
            if ( controlador.Votar( idCandidata: controlador.ListaCandidatas[ indexCandidata ].Id_candidata, tipoVoto: TipoVoto.Fotogenia ) > 0 )
            {
                MessageBox.Show( "¡VOTACION EXITOSA!", "Votación de Miss Fotogenia de la UG", MessageBoxButtons.OK, MessageBoxIcon.Information );
                controlador.VotoYaRegistradoButtonPreparer( botonVotar: this.BTNVotar );
